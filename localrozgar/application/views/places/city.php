<main class="app-content" style="background-color:white;margin-top:0">
    <div class="row" style="padding:40px">
      <div class="col-md-12">        
                ...
                <h5 class="text-center">List of City</h5>
                            ...
                            <tr>    
                                    ...
                                    <td>
                                        <form  style="display:inline;" action="#" method="post">  
                                            <input name="state" type="hidden" value="<?php echo $city->stateid ;?>">
                                            <input name="city" type="hidden" value="<?php echo $city->cityid ;?>">
                                        <button type="submit" class="btn btn-info btn-sm fa fa-edit" title="Edit"></button>
                                        </form>

                                        <form  style="display:inline;" action="<?php echo base_url('deleteCity');?>" method="post">  
                                            <input name="stateid" type="hidden" value="<?php echo $city->stateid ;?>">
                                            <input name="cityid" type="hidden" value="<?php echo $city->cityid ;?>">
...
<div class="modal fade" id="add">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <!-- Modal Header -->
                ...
                <form action="<?php echo base_url('addCity');?>" method="post">
                <?php 
