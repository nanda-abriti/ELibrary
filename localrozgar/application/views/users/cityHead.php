<main class="app-content" style="background-color:white;margin-top:0">
    <div class="row" style="padding:40px">
      <div class="col-md-12">        
                ...
                <h5 class="text-center">List of City Head</h5>
                    ...
                    <table class="table table-bordered " id="sampleTable">
                        ...
                        <?php
                            ...
                            <tr>
                                    ...
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo $cityhead->name; ?></td>
                                    <td><?php echo $cityhead->statename; ?></td>
                                    <td><?php echo $cityhead->cityname; ?></td>
                                    <td><?php echo $cityhead->contact; ?></td>
                                    <td><?php echo $cityhead->email; ?></td>
                                    <td>
                                        <form  style="display:inline;" action="#" method="post">  
                                            <input name="" type="hidden" value="<?php echo $cityhead->contact ;?>">
                                        <button type="submit" class="btn btn-info btn-sm fa fa-edit" title="Edit"></button>
                                        </form>

                                        <form  style="display:inline;" action="<?php echo base_url('delCityhead');?>" method="post">  
                                            <input name="contact" type="hidden" value="<?php echo $cityhead->contact ;?>">
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Add City Head</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <!-- Modal body -->
                <div class="modal-body">
                    <form id="addCHead" action="" method="post">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="number"  name="contact" id="contact"  class="form-control" min="0" required> 
...
<script>
    $('document').ready(function()
    {
        ...
        $('#form-submit').on('click', function()
        {
            ...
            {
                $('#addCHead').attr('action', '<?php echo base_url('addCityhead');?>');
            }
        });
